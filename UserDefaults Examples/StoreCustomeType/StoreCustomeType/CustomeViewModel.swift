...
class CustomModalViewController: UIViewController {
    ...
    lazy var contentStackView: UIStackView = {
        let spacer = UIView()
        let spacer2 = UIView()
        let stackView = UIStackView(arrangedSubviews: [noteTitleTF, descTF, spacer, saveButton])
    ...
    @objc func saveClicked() {
        guard let title = self.noteTitleTF.text, !title.isEmpty , let body = self.descTF.text, !body.isEmpty else {
            return
        }
